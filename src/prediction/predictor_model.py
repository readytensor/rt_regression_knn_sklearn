...
class Regressor:
    """A wrapper class for the K Nearest Neghbors Regressor.

    This class provides a consistent interface that can be used with other
    regressor models.
    """

    model_name = "K Nearest Neghbors Regressor"

    def __init__(
        self,
        n_neighbors: Optional[int] = 5,
        weights: Optional[str] = "uniform",
        leaf_size: Optional[int] = 10,
        **kwargs,
    ):
        """Construct a new K Nearest Neghbors Regressor.

        Args:
            n_neighbors (int, optional): Number of neighbors to use by default for
                kneighbors queries.
                Defaults to 5.
            weights (str, optional): Weight function used in prediction.
                ...
                Defaults to "uniform".
            leaf_size (int, optional): The minimum number of samples required
    ...
    def build_model(self) -> KNeighborsRegressor:
